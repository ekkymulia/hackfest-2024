...
const CalltoAction = () => {
  return (
    <section className="relative z-10 overflow-hidden bg-primary py-16 px-8 mt-40">
      <div className="container">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-1/2">
            <div className="text-center lg:text-left ">
              <div className="mb-10 lg:mb-0 ">
                <h1 className="mt-0 mb-3 text-3xl font-bold leading-tight sm:text-4xl sm:leading-tight md:text-[40px] md:leading-tight text-foreground ">
                  Start building automated serverless forms
                </h1>
                <p className="w-full text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed text-foreground"></p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 lg:w-1/2">
